          ...
          <div className="text-center">
           ...
           Make your journey easier with iConsulta. As Filipino-Canadians, we understand your unique goals and challenges. 
            ...
            <div className="mt-40 flex items-center justify-center gap-x-6">
              <a
                href="#"
                className="rounded-md bg-yellow-500 px-3.5 py-2.5 text-sm font-semibold text-black shadow-sm hover:bg-yellow-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
                Get started
              </a>
